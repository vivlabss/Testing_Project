...
namespace DataHandling
{
    class xmlParsing
    {
        ...
        static void dataRead()
        {
            ...
            StreamWriter sw = new StreamWriter(@"C:\Users\youli\Desktop\특허청공모전\data\DS.txt",false, Encoding.UTF8);
            ...
            sw = new StreamWriter(@"C:\Users\youli\Desktop\특허청공모전\data\PT.txt", false, Encoding.UTF8);
            ...
            sw = new StreamWriter(@"C:\Users\youli\Desktop\특허청공모전\data\TM.txt", false, Encoding.UTF8);
            ...
            sw = new StreamWriter(@"C:\Users\youli\Desktop\특허청공모전\data\UT.txt", false, Encoding.UTF8);
